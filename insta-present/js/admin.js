var InstaPresentAdmin;
(function($) {

	InstaPresentAdmin = function() {
		this.init();
		return this;
	};

	InstaPresentAdmin.prototype = {
		init: function() {
			var self = this;
		...
		updatePresentation: function () {
			var nonce = $('#Insta-present-nonce').val();
					...
					buttons: {
						"Update": {
							...
							click: function() {
								...
								var backgroundImage = $('#customize-control-insta_present_background_image img');
								...
								var colorBackground = $('#customize-control-insta_present_background_color .color-picker-hex').val();
								var colorText = $('#customize-control-insta_present_text_color .color-picker-hex').val();
								var colorLink = $('#customize-control-insta_present_link_color .color-picker-hex').val();
					...
					open: function() {
						...
						$.ajax({
							...
							success: function( contentEditor ) {
								...
								// Background
								var api = wp.customize, backgroundImage = api.instance( 'insta_present_background_image' );
								...
								// Colors
								$('#customize-control-insta_present_background_color .color-picker-hex').iris( 'color', slide.background_color );
								$('#customize-control-insta_present_text_color .color-picker-hex').iris( 'color', slide.text_color );
								$('#customize-control-insta_present_link_color .color-picker-hex').iris( 'color', slide.link_color );
...
//			$('#customize-control-insta_present_background_image .dropdown-content img').hide();
//			$('#customize-control-insta_present_background_image .dropdown-status').show();

			// Colors
			$('#customize-control-insta_present_background_color .color-picker-hex').val( '' ).change();
			$('#customize-control-insta_present_text_color .color-picker-hex').val( '' ).change();
			$('#customize-control-insta_present_link_color .color-picker-hex').val( '' ).change();
		...
		resizeModal: function() {
			...
			if( InstaPresentAdmin.maxModalEditorHeight < 1 ) {
				InstaPresentAdmin.maxModalEditorHeight = Math.round( $editor.height() );
			}
			editorHeightFull = Math.round( InstaPresentAdmin.maxModalEditorHeight );
...
var slideManager = new InstaPresentAdmin();
InstaPresentAdmin.maxModalEditorHeight = 0;