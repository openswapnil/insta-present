...
( function( $ ) {
	...
	// Background Color
	wp.customize( 'insta_present_background_color', function( value ) {
	...
	// Text Color
	wp.customize( 'insta_present_text_color', function( value ) {
		value.bind( function( newval ) {
	...
	// Link Color
	wp.customize( 'insta_present_link_color', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'insta_present_background_image', function( value ) {
	value.bind( function( newval ) {
