 ...
 */
class insta_present_Modal_Customizer {
	...
	public function action_admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'Insta-present-customize-controls', insta_present_Core::instance()->plugins_url . '/js/customize-controls.js', array( 'jquery' ), insta_present_Core::REVISION, true );
	...
	public function action_customize_register( $wp_customize ) {
		...
		/** COLORS **/
		$wp_customize->add_section( 'insta_present_colors', array(
			'title'   => __( 'Colors', 'Insta-present' ),
			'priority'  => 10,
			'capability' => 'read',
		) );

		// Background color
		$wp_customize->add_setting( 'insta_present_background_color', array(
			'default' => '',
		  	'sanitize_callback' => 'sanitize_hex_color',
		  	'transport' => 'postMessage',
		) );
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'insta_present_background_color', array(
			'label'   => __( 'Background Color', 'Insta-present' ),
			'section' => 'insta_present_colors',
			'settings'  => 'insta_present_background_color',
		) ) );

		// Text Color
		$wp_customize->add_setting( 'insta_present_text_color', array(
			'default' => '',
			'sanitize_callback' => 'sanitize_hex_color',
			'transport' => 'postMessage',
		) );
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'insta_present_text_color', array(
			'label'   => __( 'Text Color', 'Insta-present' ),
			'section' => 'insta_present_colors',
			'settings'  => 'insta_present_text_color',
		) ) );

		// Accent Text Color
		$wp_customize->add_setting( 'insta_present_link_color', array(
			'default' => '',
			'sanitize_callback' => 'sanitize_hex_color',
			'transport' => 'postMessage',
		) );
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'insta_present_link_color', array(
			'label'   => __( 'Link Color', 'Insta-present' ),
			'section' => 'insta_present_colors',
			'settings'  => 'insta_present_link_color',
		) ) );

		/** BACKGROUND **/
		$wp_customize->add_section( 'insta_present_background', array(
			'title'   => __( 'Background', 'Insta-present' ),
			'priority'  => 20,
			'capability' => 'read',
		) );

		// Background Image
		$wp_customize->add_setting( 'insta_present_background_image' , array(
			'transport' => 'postMessage',
			'default' => '',
		) );

		$wp_customize->add_control( new insta_present_Background_Image_Control( $wp_customize, 'insta_present_background_image', array(
			'label'   => __( 'Background Image', 'Insta-present' ),
			'section' => 'insta_present_background',
			'settings'  => 'insta_present_background_image',
			'context'   => 'Insta-present_' . $_REQUEST['tag_ID']
		) ) );

		/** EFFECTS **/
		/*
		$wp_customize->add_section( 'insta_present_effects', array(
			'title'   => __( 'Effects', 'Insta-present' ),
			'priority'  => 30,
			'capability' => 'read',
		) );

		// Transition
		$wp_customize->add_setting( 'insta_present_transition' , array(
			'transport' => 'postMessage',
			'default' => ''
		) );

		$wp_customize->add_control( 'insta_present_transition', array(
			'label'   => 'Transition',
			'section' => 'insta_present_effects',
			'type'    => 'select',
			'choices'    => array(
				'default' => 'Default',
				'cube' => 'Cube',
		...
		*/
		...
		/** SPEAKER NOTES **/
		/*
		$wp_customize->add_section( 'insta_present_speaker_notes', array(
			'title'   => __( 'Speaker Notes', 'Insta-present' ),
			'priority'  => 40,
			'capability' => 'read',
		) );

		// Aside
		$wp_customize->add_setting( 'insta_present_aside' , array(
			'transport' => 'postMessage',
			'default' => ''
		) );

		$wp_customize->add_control( 'insta_present_aside', array(
			'label'   => 'Aside',
			'section' => 'insta_present_speaker_notes',
			'type'    => 'text',
		) );
		*/
...
insta_present_Modal_Customizer::instance();
